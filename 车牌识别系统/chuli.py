...
class App(ttk.Frame):
    ...
    def __init__(self, win):
        ...
        self.pack()
        win.title("车牌识别系统")
        win.geometry('+300+200')#将其位置设置为屏幕坐标(300, 200)
        ...
        self.jiazai()
#接收一个BGR格式的图像（OpenCV默认的图像格式），并进行处理
