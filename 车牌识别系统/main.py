...
import image_processing as predict
import function as img_math
import svm_message as img_rec
...
class UI_main(ttk.Frame):
    ...
    def pic(self, pic_path):
        ...
        first_img, oldimg = self.predictor.img_first_process(img_bgr)
        ...
        try:
            ...
            s=catcher(img_bgr)
            # Plate = HyperLPR_plate_recognition(img_bgr)
            r_color = s[0][0]
        except:
            pass
